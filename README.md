...
* [x] Planned to fetch top-stories too. But, I was facing issues in parsing JSON to POJO. One of the fields(i.e multimedia) is of type array, and when the array is empty, it is of type String. 
